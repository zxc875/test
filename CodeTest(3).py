...
class MainSerial:
    ...
    def __init__(self):
        ...
        self.button_232 = tk.Button(
            ...
            font=("宋体", 9),
            bg='lightGray',
            width=10,command=lambda:self.write_data(Flag_Num='0D',Flag_bit='Bit1-0',byte='00'),
            height=1)
        ...
        self.button_HID = tk.Button(
            ...
            text="USB-HID",  
            font=("宋体", 9),
            bg='lightGray',command=lambda:self.write_data(Flag_Num='0D',Flag_bit='Bit1-0',byte='01'),
            width=10,
            height=1)
        ...
        self.button_VCP = tk.Button(
            ...
            text="虚拟串口",  
            font=("宋体", 9),
            bg='lightGray',command=lambda:self.write_data(Flag_Num='0D',Flag_bit='Bit1-0',byte='11'),
            width=10,
            height=1)
        ...
        self.button_HIDTTL = tk.Button(
            ...
            text="HID/TTL同时",  
            font=("宋体", 9),
            bg='lightGray',command=lambda:self.write_data(Flag_Num='0D',Flag_bit='Bit1-0',byte='10'),
            width=10,
            height=1)
        self.button_HIDTTL.place(x=25, y=200)
        self.button_star = tk.Button(tab1,text='触发识读命令',  
            font=("宋体", 9),bg='lightGray',command=lambda:self.write_data(Flag_Num='02',Flag_bit='Bit0',byte='1'),width=10)
        ...
        self.btn_shoudong = Button(tab1,
                                   ...
                                   width=12,
                                   bg='lightGray',
                                   command=lambda: self.write_data(Flag_Num='00',Flag_bit='Bit1-0',byte='00'))
        ...
        self.btn_lianxu = Button(tab1,
                                 ...
                                 width=12,
                                 bg='lightGray',
                                 command=lambda: self.write_data(Flag_Num='00',Flag_bit='Bit1-0',byte='10'))
        self.btn_lianxu.place(x=25, y=400)
        self.btn_mingling = Button(tab1,
                                   text='命令触发模式',
                                   width=12,
                                   bg='lightGray',
                                   command=lambda: self.write_data(Flag_Num='00',Flag_bit='Bit1-0',byte='01'))
        self.btn_mingling.place(x=165, y=365)
        self.btn_ganying = Button(tab1,
                                  text='感应模式',
                                  width=12,
                                  bg='lightGray',
                                  command=lambda: self.write_data(Flag_Num='00',Flag_bit='Bit1-0',byte='11'))
        ...
        self.btn_CR=Button(tab1,text='CR', height=1,bg='lightGray',command=lambda:self.write_data(Flag_Num='60',byte='00',Flag_bit='Bit6-5'))
        self.btn_CR.place(x=460,y=412)
        self.btn_TAB=Button(tab1,text='TAB', height=1,bg='lightGray',command=lambda:self.write_data(Flag_Num='60',byte='10',Flag_bit='Bit6-5'))
        self.btn_TAB.place(x=500,y=412)
        self.btn_CRLF=Button(tab1,text='CRLF', height=1,bg='lightGray',command=lambda:self.write_data(Flag_Num='60',byte='01',Flag_bit='Bit6-5'))
        self.btn_CRLF.place(x=540,y=412)
        self.btn_None=Button(tab1,text='无', height=1,bg='lightGray',command=lambda:self.write_data(Flag_Num='60',byte='11',Flag_bit='Bit6-5'))
    ...
    def replace_bit(self,Flag_bit,write_byte,query):  ###替换对应位置
        ...
        return a
    def write_data(self,Flag_Num,Flag_bit,byte,):###写入对应位置，并保存
        try:
